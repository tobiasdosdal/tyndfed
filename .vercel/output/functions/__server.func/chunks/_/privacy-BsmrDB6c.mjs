...
function Privacy() {
  ...
  return /* @__PURE__ */ jsxs(WindowChrome, { children: [
    /* @__PURE__ */ jsxs("div", { className: "content-area", children: [
      /* @__PURE__ */ jsxs("nav", { className: "lang-switch", children: [
        /* @__PURE__ */ jsx("button", { className: lang === "da" ? "active" : "", onClick: () => setLang("da"), children: "Dansk" }),
        /* @__PURE__ */ jsx("button", { className: lang === "en" ? "active" : "", onClick: () => setLang("en"), children: "English" })
      ] }),
      /* @__PURE__ */ jsxs("section", { className: "legal-section", children: [
        /* @__PURE__ */ jsx("h2", { children: content.privacy.title }),
        /* @__PURE__ */ jsx("p", { className: "updated", children: content.privacy.updated }),
        content.privacy.sections.map((s) => /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h3", { children: s.heading }),
          /* @__PURE__ */ jsx("p", { children: s.text })
        ] }, s.heading))
      ] }),
      /* @__PURE__ */ jsx("hr", {}),
      /* @__PURE__ */ jsxs("section", { className: "legal-section", children: [
        /* @__PURE__ */ jsx("h2", { children: content.terms.title }),
        /* @__PURE__ */ jsx("p", { className: "updated", children: content.terms.updated }),
        content.terms.sections.map((s) => /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h3", { children: s.heading }),
          /* @__PURE__ */ jsx("p", { children: s.text })
        ] }, s.heading))
      ] }),
